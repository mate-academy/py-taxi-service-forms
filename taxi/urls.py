...
from .views import (
    ...
    CarListUpdateView, CarListCreateView,
    CarListDeleteView, ManufacturerListCreateView,
    ManufacturerListUpdateView, ManufacturerListDeleteView,
)
...
urlpatterns = [
    ...
    path(
        ...
        name="manufacturer-list-update"
    ),
    path(
        "manufacturers/<int:pk>/delete/",
        ManufacturerListDeleteView.as_view(),
        name="manufacturer-list-delete"
    ),
