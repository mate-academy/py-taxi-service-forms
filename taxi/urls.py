...
from .views import index, CarListView, CarDetailView, DriverListView, DriverDetailView,\
    ManufacturerListView, DriverCreateView, DriverDeleteView, ManufacturerCreateView,\
    ManufacturerUpdateView, ManufacturerDeleteView, CarCreateView, CarUpdateView,\
    CarDeleteView, DriverUpdateView
