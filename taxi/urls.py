...
from .views import index, CarListView, CarDetailView, DriverListView, DriverDetailView, ManufacturerListView, \
    ManufacturerCreateView, CarCreateView, DriverCreateView, ManufacturerDeleteView, ManufacturerUpdateView, \
    CarDeleteView, CarUpdateView, DriverDeleteView, DriverLicenseUpdateView, car_assign
