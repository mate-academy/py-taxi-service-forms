...
urlpatterns = [
    ...
    path("manufacturers/<int:pk>/update/", ManufacturerUpdateView, name="manufacturer-update"),
    path("manufacturers/<int:pk>/delete/", ManufacturerDeleteView.as_view(), name="manufacturer-delete"),
    path("manufacturers/create/", ManufacturerCreateView.as_view(), name="create-manufacturer"),
