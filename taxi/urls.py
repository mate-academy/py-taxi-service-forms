...
urlpatterns = [
    ...
    path("cars/<int:pk>/add-user-to-drivers/", car_add_driver_view, name="car-add-driver"),
    path("cars/<int:pk>/delete-user-from-drivers/", car_delete_driver_view, name="car-delete-driver"),
    path("drivers/", DriverListView.as_view(), name="driver-list"),
    path("drivers/<int:pk>/", DriverDetailView.as_view(), name="driver-detail"),
    path("drivers/create/", DriverCreateView.as_view(), name="driver-create"),
    path("drivers/<int:pk>/delete/", DriverDeleteView.as_view(), name="driver-delete"),
    path("driver-licese/<int:pk>/update/", DriverLicenseUpdateView.as_view(), name="driver-license-update"),
]
