...
from .views import index, ManufacturerListView, CarListView, CarDetailView, DriverListView, DriverDetailView, \
    ManufacturerDetailView, ManufacturerCreateView, ManufacturerUpdateView, ManufacturerDeleteView, CarCreateView, \
    CarUpdateView, CarDeleteView, DriverCreateView, LicenseUpdateView, DriverDeleteView, assign_or_delete, \
    DriverUpdateView
...
urlpatterns = [
    ...
    path("drivers/<int:pk>/update-license/", LicenseUpdateView.as_view(), name="license-update"),
    ...
    path("drivers/<int:pk>/assign_or_delete/", assign_or_delete, name="assign_or_delete")
]
