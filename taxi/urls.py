...
from .views import index, CarListView, CarDetailView, DriverListView, DriverDetailView, ManufacturerListView,\
    CarCreateView, CarUpdateView, CarDeleteView, ManufacturerCreateView, ManufacturerUpdateView,\
    ManufacturerDeleteView, DriverCreateView, DriverDeleteView, DriverLicenseUpdateView, assign_to_car
