...
urlpatterns = [
    ...
    path("manufacturers/dlete/<int:pk>/",
    ...
    path("cars/<int:pk>/", CarDetailView.as_view(),
         name="car-detail"),
    path("cars/craete/", CarCreateView.as_view(),
         name="car-create"),
    path("cars/update/<int:pk>/", CarUpdateView.as_view(),
         name="car-update"),
    path("cars/delete/<int:pk>/", CarDeleteView.as_view(),
         name="car-delete"),
