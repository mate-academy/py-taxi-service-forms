...
urlpatterns = [
    ...
    path("cars/<int:pk>/add-current-driver/", car_add_current_driver, name="car-add-current-user"),
    path("cars/<int:pk>/delete-current-driver/", car_delete_current_driver, name="car-delete-current-user"),
    ...
    path("drivers/<int:pk>/driver-license-update/", DriverLicenseUpdate.as_view(), name="driver-license-update"),
